    ...
    <public-layout title="Events">
        ...
        <div class="bg-gradient-to-b from-white to-gray-100 dark:from-gray-800 dark:to-gray-800">
            <div class="text-center mt-16 sm:mt-12 md:mt-16 lg:mt-20 xl:mt-28 pb-20 px-5">
                ...
                <p
                    class="mt-3 max-w-5xl lg:max-w-4xl text-gray-500 dark:text-gray-400 mx-auto text-xl sm:text-lg md:mt-5 lg:max-w-3xl md:text-xl">
                    Wir sind nicht nur eine Kirche, wir sind Gemeinschaft. Sie sind herzlich willkommen unsere
            ...
            <div class="pb-28 max-w-7xl mx-auto">
                <ul role="list"
                    class="px-4 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3 text-base text-gray-500 dark:text-gray-300">
                    <li v-for="event in events" :key="event.email"
                        class="col-span-1 flex flex-col bg-white dark:bg-gray-700 rounded-2xl shadow-sm ring-1 ring-gray-900/5 dark:ring-white/10 divide-y divide-gray-100 dark:divide-gray-600 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
                            ...
                            <div class="mt-5 space-y-3">
                                <div class="flex items-center">
                                    <span class="inline-flex items-center justify-center h-9 w-9 rounded-lg bg-brand-primary-50 dark:bg-brand-primary-900">
                                        <CalendarIcon class="h-5 w-5 text-brand-primary-600 dark:text-brand-primary-300" />
                                    </span>
                                    <p class="ml-3">{{ event.interval }}</p>
                                </div>
                                <div class="flex items-center">
                                    <span class="inline-flex items-center justify-center h-9 w-9 rounded-lg bg-brand-secondary-50 dark:bg-brand-secondary-900">
                                        <ClockIcon class="h-5 w-5 text-brand-secondary-700 dark:text-brand-secondary-300" />
                                    </span>
                                    <p class="ml-3">{{ event.time }}</p>
                                </div>
                                <div class="flex items-center">
                                    <span class="inline-flex items-center justify-center h-9 w-9 rounded-lg bg-gray-100 dark:bg-gray-600">
                                        <UserCircleIcon class="h-5 w-5 text-gray-500 dark:text-gray-300" />
                                    </span>
                                    <p class="ml-3">{{ event.responsible }}</p>
                                </div>
                            </div>
                        ...
                        <div>
                            <div class="-mt-px flex divide-x divide-gray-100 dark:divide-gray-600">
                                ...
                                <div class="-ml-px w-0 flex-1 flex text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-600">
                                    <a :href="`tel:${event.phone}`"
                                        class="relative w-0 flex-1 inline-flex items-center justify-center py-4 text-sm font-medium border border-transparent rounded-br-2xl transition-colors">
